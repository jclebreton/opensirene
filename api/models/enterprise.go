...
type Enterprise struct {
	...
	DAPET      string `json:"dapet" gorm:"column:dapet"`           // Année de validité de l'activité principale de l'établissement
	...
	DEfet      string `json:"defet" gorm:"column:defet"`           // Année de validité de l'effectif salarié de l'établissement
	...
	DDebAct    string `json:"ddebact" gorm:"column:ddebact"`       // Date de début d’activité
	...
	DAPEN     string `json:"dapen" gorm:"column:dapen"`         // Année de validité de l'activité principale de l'entreprise
	...
	DEfEn     string `json:"defen" gorm:"column:defen"`         // Année de validité de l'effectif salarié de l'entreprise
	...
	ESAANN    string `json:"esaann" gorm:"column:esaann"`       // Année de validité des rubriques de niveau entreprise en provenance de l'ESA*
	...
	DateMaj string `json:"datemaj" gorm:"column:datemaj"` // Date de traitement de la mise à jour
}
