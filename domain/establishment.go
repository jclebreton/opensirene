...
type Establishment struct {
	...
	AmintrEt   *time.Time // Année et mois d'introduction de l'établissement dans la base de diffusion
	...
	DCret      *time.Time // Année et mois de création de l'établissement
	...
	DCrEn     *time.Time // Année et mois de création de l'entreprise
	AmintrEn  *time.Time // Année et mois d'introduction de l'entreprise dans la base de diffusion
